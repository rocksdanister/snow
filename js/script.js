...
function livelyPropertyListener(name, val) {
  switch (name) {
    case "blurIntensity":
      material.uniforms.u_blur_intensity.value = val;
      break;
    case "layers":
      material.uniforms.u_layers.value = val;
      break;
    case "depth":
      material.uniforms.u_depth.value = val;
      break;
    case "width":
      material.uniforms.u_width.value = val;
      break;
    case "speed":
